...
const initLocalSearch = () => {
  if (window.localSearchRun) return
  window.localSearchRun = true
...
if (document.readyState === 'complete') initLocalSearch()
else window.addEventListener('load', initLocalSearch, { once: true })
